      ...
      <div style={{ flex: 1, overflowY: 'auto', minHeight: 0, marginBottom: 16 }}>
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              {showApiKey ? <Eye size={18} color="var(--text-muted)" /> : <EyeOff size={18} color="var(--text-muted)" />}
            </button>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              {showSecretKey ? <Eye size={18} color="var(--text-muted)" /> : <EyeOff size={18} color="var(--text-muted)" />}
            </button>
          </div>
        </div>

...
const STRATEGIES = [
  ...
  { key: 'rebalance', name: 'Portfolio Rebalancing', icon: '⚖️', desc: 'Restore target allocations when drift exceeds threshold', path: '/strategies/setup/rebalance', available: false },

...
import { STAGE1_CARDS } from './topics/stage1';
import { STAGE2_CARDS } from './topics/stage2';
import { STAGE3_CARDS } from './topics/stage3';
import { STAGE4_CARDS } from './topics/stage4';
...
const ESSENTIALS: Record<string, LearningCard> = {
  'P/E ratio': {
    ...
    level: 'Apprentice', category: 'Essentials',
...
const MARKETS: Record<string, LearningCard> = {
  'bull market': {
    ...
    level: 'Apprentice', category: 'Markets & Cycles',
  ...
  'yield curve': {
    ...
    level: 'Trader', category: 'Markets & Cycles',
...
const ANALYSIS: Record<string, LearningCard> = {
  'earnings per share': {
    ...
    level: 'Apprentice', category: 'Analysis & Metrics',
  ...
  'beta': {
    ...
    level: 'Trader', category: 'Analysis & Metrics',
  ...
  'alpha': {
    ...
    level: 'Investor', category: 'Analysis & Metrics',
...
const STRATEGIES: Record<string, LearningCard> = {
  'mean reversion': {
    ...
    level: 'Trader', category: 'Strategies',
  ...
  'dollar cost averaging': {
    ...
    level: 'Investor', category: 'Strategies',
...
const RISK: Record<string, LearningCard> = {
  'portfolio diversification': {
    ...
    level: 'Investor', category: 'Risk & Portfolio',
  ...
  'stop loss': {
    ...
    level: 'Trader', category: 'Risk & Portfolio',
...
const TECHNICAL: Record<string, LearningCard> = {
  'moving average': {
    ...
    level: 'Trader', category: 'Technical Analysis',
...
const MECHANICS: Record<string, LearningCard> = {
  'market order': {
    ...
    level: 'Apprentice', category: 'Trading Mechanics',
...
export const LEARNING_CARDS: Record<string, LearningCard> = {
  ...
  ...TECHNICAL,
  ...MECHANICS,
  // Curriculum expansion (Stage 1–4) — see lib/learning/curriculum.ts for the ordered path.
  ...STAGE1_CARDS,
  ...STAGE2_CARDS,
  ...STAGE3_CARDS,
  ...STAGE4_CARDS,

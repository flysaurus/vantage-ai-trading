...
export const DEMO_PORTFOLIOS: Record<InvestorStyle, DemoPortfolio> = {
  ...
  lynch: {
    ...
    positions: [
      { symbol: 'META', name: 'Meta Platforms', sector: 'Technology', industry: 'Social Media', qty: 50, avgCost: 580, weekHigh52: 625, weekLow52: 380 },
      ...
      { symbol: 'NFLX', name: 'Netflix Inc.', sector: 'Media & Entertainment', industry: 'Streaming', qty: 25, avgCost: 950, weekHigh52: 1050, weekLow52: 540 },

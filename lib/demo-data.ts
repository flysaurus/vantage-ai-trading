...
export const DEMO_PORTFOLIOS: Record<InvestorStyle, DemoPortfolio> = {
  ...
  lynch: {
    ...
    positions: [
      { symbol: 'META', name: 'Meta Platforms', sector: 'Technology', industry: 'Social Media', qty: 50, avgCost: 285.40, weekHigh52: 593, weekLow52: 214 },
      { symbol: 'MSFT', name: 'Microsoft Corp.', sector: 'Technology', industry: 'Cloud Software', qty: 40, avgCost: 378.20, weekHigh52: 473, weekLow52: 284 },
      { symbol: 'GOOGL', name: 'Alphabet Inc.', sector: 'Technology', industry: 'Internet Services', qty: 45, avgCost: 142.80, weekHigh52: 179, weekLow52: 107 },
      { symbol: 'AMZN', name: 'Amazon.com Inc.', sector: 'Consumer', industry: 'E-Commerce', qty: 60, avgCost: 158.30, weekHigh52: 198, weekLow52: 119 },
      { symbol: 'NVDA', name: 'NVIDIA Corp.', sector: 'Technology', industry: 'Semiconductors', qty: 30, avgCost: 485.20, weekHigh52: 607, weekLow52: 364 },
      { symbol: 'CRM', name: 'Salesforce Inc.', sector: 'Technology', industry: 'Enterprise Software', qty: 70, avgCost: 195.60, weekHigh52: 245, weekLow52: 147 },
      { symbol: 'NFLX', name: 'Netflix Inc.', sector: 'Media & Entertainment', industry: 'Streaming', qty: 25, avgCost: 445.30, weekHigh52: 557, weekLow52: 334 },
      { symbol: 'ADBE', name: 'Adobe Inc.', sector: 'Technology', industry: 'Design Software', qty: 20, avgCost: 520.40, weekHigh52: 651, weekLow52: 390 },
      { symbol: 'UBER', name: 'Uber Technologies', sector: 'Technology', industry: 'Ridesharing', qty: 120, avgCost: 62.80, weekHigh52: 79, weekLow52: 47 },
      { symbol: 'SQ', name: 'Block Inc.', sector: 'Financial Services', industry: 'Fintech', qty: 85, avgCost: 68.20, weekHigh52: 85, weekLow52: 51 },
    ],
  },
  livermore: {
